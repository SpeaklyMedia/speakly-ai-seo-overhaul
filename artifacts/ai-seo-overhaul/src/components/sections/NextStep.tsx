        ...
        >
          ...
          >
            <img
              ...
              width={200}
              height={200}
              style={{ display: "block", opacity: 0.84 }}
            />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-[40px] items-start relative z-10">
            <div>
              ...
              <div className="flex flex-wrap gap-[14px]">
                <a
                  className="cta-pulse inline-flex items-center justify-center gap-[10px] min-h-[50px] px-[24px] rounded-full font-bold tracking-[0.01em] transition-all duration-300 border border-transparent cursor-pointer text-[#04101c] bg-gradient-to-br from-teal to-blue hover:-translate-y-[2px]"
                  href="mailto:mark@speaklymedia.com?subject=AI-Search%20Readiness%20Assessment"
